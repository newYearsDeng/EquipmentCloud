...
public class ALLDeviceListItemView extends RelativeLayout {
	...
	public ALLDeviceListItemView(Context context, BluetoothDevice device) {
		super(context);
	...
	public ALLDeviceListItemView(Context context, AttributeSet attrs){
		super(context,attrs);
		this.context = context;
		init();
		initData();
