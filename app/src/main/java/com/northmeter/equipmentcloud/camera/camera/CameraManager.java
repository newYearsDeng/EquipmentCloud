...
package com.northmeter.equipmentcloud.camera.camera;
...
import com.northmeter.equipmentcloud.camera.open.OpenCameraInterface;
...
//	/*闪光灯的开关*/
//	//提供給其他activity調用
    public static boolean flashHandler() {  
    	boolean flag = false;
        camera.startPreview();  
