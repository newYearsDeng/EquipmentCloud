package com.northmeter.equipmentcloud.widget.time;
...
import com.northmeter.equipmentcloud.widget.time.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.wheel_val;
